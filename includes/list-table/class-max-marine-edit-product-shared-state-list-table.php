 ...
 * @subpackage Max_Marine\Edit_Product_Shared_State/admin
 * @author     David Baumwald <david@dream-encode.com>
 */

namespace Max_Marine\Edit_Product_Shared_State\Core\ListTable;
 ...
 * @author     David Baumwald <david@dream-encode.com>
 */
class Max_Marine_Edit_Product_Shared_State_List_Table extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct(
			array(
				'singular' => __( 'Thing', 'max-marine-edit-product-shared-state' ),
				'plural'   => __( 'Things', 'max-marine-edit-product-shared-state' ),
				'ajax'     => false,
			)
		);
	}
	...
	public function no_items() {
		esc_html_e( 'No things.', 'max-marine-edit-product-shared-state' );
	}
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'timestamp':
				...
				if ( ! $date ) {
					$date = __( 'N/A', 'max-marine-edit-product-shared-state' );
				}
	...
	public function get_columns() { // @phpcs:ignore @phpstan-ignore-line
		$columns = array(
			'timestamp' => __( 'Date', 'max-marine-edit-product-shared-state' ),
			'id'        => __( 'ID', 'max-marine-edit-product-shared-state' ),
		);
